...
import org.codeforall.boolpong.grid.Grid;
...
public class SimpleGfxGrid implements Grid {
    ...
    public GridPosition makeGridPosition() {
        return new SimpleGfxGridPosition(new SimpleGfxGrid(cols, rows));
    }
    ...
    public GridPosition makeGridPosition(int col, int row) {
        return new SimpleGfxGridPosition(col, row, new SimpleGfxGrid(col, row));
    }
